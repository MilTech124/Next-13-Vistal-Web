...
export function BlaszakSpadTyl(props) {
  ...
  const {Doortxt,colorTxt,ocynkTxt,ocynkDoor,wood,woodGate2,gateColorTXT,gateTextureSegment,roofMat}=Materials(width,depth)
