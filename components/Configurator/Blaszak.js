...
export function Blaszak(props) {
  ...
  // MATERIAL WOOD
   const wood = useTexture({
    ...
    // normaMap:"./configurator/texture/normal.png" ,    
      })
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group visible={false}>
        <mesh geometry={nodes.bryla1.geometry} castShadow material={materials.drzwi} position={[0, 1.25, 0]} />
        <mesh geometry={nodes.dach1.geometry} castShadow material={materials.drzwi} position={[0, 2.55, 0]} rotation={[0, 0, -0.08]} />
