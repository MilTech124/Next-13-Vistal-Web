      ...
      <div className="flex justify-between py-20 max-md:py-2 max-md:flex-col-reverse ">
        <div className="flex flex-col items-center w-[50%] max-md:w-auto">
          ...
          <div className="flex pt-5 gap-10">
            <a className="hover:scale-105 hover:bg-slate-500/50 p-2 rounded-md transition-all" href="https://www.google.com/maps/place/Vistal+Producent+Gara%C5%BCy+Blaszanych/@49.7848937,20.2338387,11.75z/data=!4m15!1m8!3m7!1s0x47161a4814e44949:0xfdb27ddbbb9b0876!2sRupni%C3%B3w+211,+34-652+Rupni%C3%B3w!3b1!8m2!3d49.7696396!4d20.3357047!16s%2Fg%2F11j3hry90s!3m5!1s0x47161bd08a245477:0x8d7b7e1afd9a9dec!8m2!3d49.769658!4d20.3357469!16s%2Fg%2F11h3vgc_pd?entry=ttu">             
