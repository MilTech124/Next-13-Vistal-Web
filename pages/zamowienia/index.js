...
import {logout,login} from '../../store/reducers/user.reducer'
...
function  sign_in() {
    ...
    const Login =()=> dispatch(login() ,console.log(user))
  ...
  return (
    <div className='flex flex-col items-center py-20'>
        ...
        <Button onClick={Login} className='!bg-red-700' variant="contained">Zaloguj</Button>          
